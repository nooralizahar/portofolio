	...
	<nav class="navbar navbar-expand-md navbar-light fixed-top shadow-sm bg-white py-3">
		<div class="container">
			<div class="d-none d-lg-block justify-content-sm-center w-25">
				<a class="navbar-brand mr-0" href=""><img src="assets/images/logo.png" style="height: 40px" alt="logo"></a>
			</div>
	...
	<div data-aos="fade-right" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="section bg-white" id="about">
		...
		<div class="container">
			<div class="row no-gutters">
				<div class="col-md-4">
					<img src="assets/images/foto.jpg" class="card-img img-fluid rounded-circle" style="height:400px" alt="...">
				</div>
				<div class="col-md-8">
					<div class="card-body">
		...
		<div class="container">
			<div class="row">
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/html.png" class="img-fluid" style="height: 100px;" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/boot.png" class="img-fluid" style="height: 100px;" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/php.png" class="img-fluid" style="height: 100px;" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/python.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/ci.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/laravel.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/django.webp" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/java.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/mysql.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/post.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/vbnet.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 col-6 text-center text-muted p-3">
					<img src="assets/images/skill/ar.png" style="height: 100px;" class="img-fluid" alt="...">
					<div>
		...
		<div class="container">
			<div class="row">
				<div data-aos="zoom-in-up" data-aos-anchor-placement="top-center" data-aos-duration="2000" class="col-md-4 col-12 text-muted p-3">
					<div class="card">
						<img src="assets/images/hobby/book.png" style="height: 250px" class="card-img-top" alt="...">
						<div class="card-body">
				...
				<div data-aos="zoom-in-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-4 col-12 text-muted p-3">
					<div data-aos="zoom-in-up" class="card">
						<img src="assets/images/hobby/chess.png" style="height: 250px" class="card-img-top" alt="...">
						<div class="card-body">
				...
				<div data-aos="zoom-in-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-4 col-12 text-muted p-3">
					<div class="card">
						<img src="assets/images/hobby/movie.png" style="height: 250px" class="card-img-top" alt="...">
						<div class="card-body">
			...
			<div class="row">
					...
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/smkn1.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/kominfo.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/lks.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/udemy.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/trilogi.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/dinacom.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/gdk.png" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
				...
				<div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-4 p-2 col-6">
					<div class="card p-2">
						<div class="row no-gutters">
							<div class="col-md-4 col-12">
								<img src="assets/images/achievement/iak.jpg" style="height: 150px" class="rounded img-fluid" alt="...">
							</div>
							<div class="col-md-8 col-12">
								<div class="card-body">
		...
		<div class="container">
			<div class="row">
				<div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 p-2 text-center col-6">
					<img src="assets/images/experience/dev.png" style="height: 150px;" class="img-fluid rounded-circle mb-3">
					<h4>Freelance</h4>
					<p>Freelance Programmer</p>
					<p><span>2017-Now</span></p>
				</div>
				<div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 p-2 text-center col-6">
					<img src="assets/images/experience/koin.png" style="height: 150px;" class="img-fluid rounded-circle mb-3">
					<h4>KO-IN (Toko Indonesia)</h4>
					<p>Contract Programmer</p>
					<p><span>2019-Now</span></p>
				</div>
				<div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 p-2 text-center col-6">
					<img src="assets/images/experience/powernet.png" style="height: 150px;" class="img-fluid rounded-circle mb-3">
					<h4>PT. Powernet Indosolution</h4>
					<p>Freelance Programmer</p>
					<p><span>2020-Now</span></p>
				</div>
				<div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-3 p-2 text-center col-6">
					<img src="assets/images/experience/noimage.png" style="height: 150px;" class="img-fluid rounded-circle mb-3">
					<h4>PT.MAAI</h4>
					<p>Freelance Programmer</p>
					<p><span>2020-Now</span></p>
				</div>
		...
		<div class="container">
			<div class="row">
				<div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1000" class="col-md-4 text-center foot-img">
					<img src="assets/images/logo.png" style="height: 100px" class="img-fluid">
				</div>
